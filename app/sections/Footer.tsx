      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr 1fr', gap: '48px', marginBottom: '48px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
              {services.map((s, i) => (
                <Link key={i} href={s.href} style={{ fontSize: '12px', color: '#5E7090', textDecoration: 'none', lineHeight: '1.6' }}>
                  {isRTL ? s.ar : s.en}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {company.map((c, i) => (
                <Link key={i} href={c.href} style={{ fontSize: '12px', color: '#5E7090', textDecoration: 'none' }}>
                  {isRTL ? c.ar : c.en}
                </Link>
              ))}
            </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
          ...
          <div style={{ fontSize: '12px', color: '#5E7090' }}>
            ...
            <span style={{ color: '#00D4AA', margin: '0 6px' }}>●</span>
            <a href="https://wa.me/96550441803" target="_blank" rel="noreferrer" style={{ color: '#00D4AA', textDecoration: 'none', fontWeight: '700' }}>+965 504 41803</a>
          </div>
        </div>
      </div>
    </footer>
